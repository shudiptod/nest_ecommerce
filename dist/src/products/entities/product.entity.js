...
let Product = class Product {
    calculateDiscountedPrice() {
        ...
        if (this.discount_percent && this.discount_percent > 0) {
            this.discounted_price = Number((this.price * (1 - this.discount_percent / 100)).toFixed(2));
        }
    }
};
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => categories_entity_1.Category, { nullable: true }),
...
], Product.prototype, "calculateDiscountedPrice", null);
